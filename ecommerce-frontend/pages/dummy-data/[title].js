...
const DummyDataPage = () => {
  ...
  return (
    <>
      <Head>
        <title>IKEA || {capitalizeFirstLetter(pageId)} </title>
        <meta
          name="description"
          content={`dummy data for ${capitalizeFirstLetter(pageId)}`}
        />
      </Head>
      <div className="container">
        <h1 className="dummy_page_title">
          Dummy data for {capitalizeFirstLetter(pageId)}
        </h1>
